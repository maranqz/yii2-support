...
trait ModelGetParamsTrait
{
    public function getModelAttributesByFields($class, array $neededFields)
    {
        return array_intersect_key($this->make($class)->attributeLabels(), array_flip($neededFields));
    }
